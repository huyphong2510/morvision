...
import NAME_FIELD from '@salesforce/schema/TaskCustom__c.Name';
import STATUS_FIELD from '@salesforce/schema/TaskCustom__c.Status__c';
import END_DATE_FIELD from '@salesforce/schema/TaskCustom__c.End_Date__c';



const fields = [];
var DUMMY_RECORDTYPE_ID = 'a025i000003HvzkAA';
...
export default class PathComponent extends LightningElement {
    ...
    fields = [NAME_FIELD,STATUS_FIELD,END_DATE_FIELD];
    handleSubmit(event) {
